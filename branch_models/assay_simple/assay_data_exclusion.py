...
# -*- coding: utf-8 -*-
"""
Created on Tue May 25 12:54:36 2021
...
with open('TEST2_DATA', 'a') as out_file:
    ...
    for n in all_sentences_nodupes:
        ...
        if "Illumina" and "Affymetrix" in n:
...
with open('/project/home20/nam220/NER/NLP/TEST2_DATA_runtime.log', 'a') as time_file:   #start and stop time are written into a runtime.log file
